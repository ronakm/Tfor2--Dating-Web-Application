        ...
        <section>
            ...
            <div class="navigation">
               ...
               <ul>
                ...
                <p> <a href="<?php echo base_url(); ?>welcome/image_gallery/both">Home</a> > View profile</p>
                   ...
                   <div class="option">
                       ...
                       <ul>
                           ...
                           <li>
                            ...
                            <li>
                               <a href="<?php echo base_url(); ?>welcome/send_email/<?php echo $basic_info[0]->id; ?>" class="email">
                  ...
                  <?php  if(empty($detail_info))
                    { ?>
                      ...
                      <div class="demo-show2" id="profile_accordian">
                        ...
                        <p><span>The basics </span><a href="#">Empty </a> </p>
                        <p><span>More facts 'n' figures</span><a href="#">Empty </a> </p>
                        <p><span>The real detail</span><a href="#">Empty </a> </p>
