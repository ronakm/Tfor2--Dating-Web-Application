...
<title>Forget Fail</title>
<meta name="description" content="Dating Site,Forget Passwords Fail Messages">
<meta charset="UTF-8" />
...
<body>
    ...
    <div class="container">
        ...
        <section>
            <h3>Forget Password Fail</h3>
           
            <p id="error_msg"> Problem is occured during forget password(<?php echo $error; ?>) </p>
            <a id="home_link" href="<?php echo base_url(); ?>welcome/image_gallery/both">Click here to go Home </a>
