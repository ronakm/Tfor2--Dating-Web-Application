...
<script type="text/javascript">
 $(document).ready(function() {
   ...
   /* $("#email").leanModal({ top : 200, overlay : 0.4, closeButton: ".modal_close" });*/
    ...
    $("#search_form  .own_words .display .edit").click(function() {
      
         $("#search_form  .own_words .edit_words").show();
         $("#search_form  .own_words .display").hide();
    });
    
     $("#search_form .own_words .edit_words .save").click(function() {
      
        var value=$('#search_form .own_words .edit_words textarea').val();
        $.ajax({
                  url: '<?php echo base_url(); ?>welcome/save_words/',
                  type: "POST",
                  data:{'words':value},
                  dataType: 'json',
                  success: function(output_string)
                  {
                    ...
                    $("#search_form  .own_words .edit_words").hide();
                    $("#search_form  .own_words .display").show();
     ...
     $("#search_form .own_words .edit_words .cancel").click(function() { 
           ...
           <div class="profile_content">
               ...
               <div class="main_profile_content">
                   ...
                   <div id="profile_navigation">
                        ...
                        <ul>
                             <a href="<?php echo base_url(); ?>welcome/upload_img/<?php echo $basic_info[0]->id; ?>">
                                 <li class="photo">
                                 My Photos
                                 </li>
                             </a>
                   ...
                   <div id="search_form">
                       <div class="own_words">
                           <?php if($basic_info[0]->own_words=='') { ?>
                           <div class="display">
                                <div>Say a few words about yourself and press save when finished.</div>
                                <p class="edit">Edit </p>
                           </div>
                           <div class="edit_words">
                               <textarea class="words" name="words" id="own_words"></textarea>
                               <p> Save </p>
                           </div>
                           <?php  } else { ?>
                           <div class="display">
                                <div><?php echo $basic_info[0]->own_words ?></div>
                                <p class="edit">Edit </p>
                           </div>
                           <div class="edit_words">
                               <textarea class="words" name="words" id="own_words"><?php echo $basic_info[0]->own_words ?></textarea>
                               <p class="save"> Save </p> <p class="cancel ">Cancel</p>
                           </div>
                           <?php } ?>
                       </div>
                   </div>
