...
$(document).ready(function() {
    ...
    { 
             ...
             if ($(temp).next('.click_here').is(':hidden'))
            {
             ...
             var msg_id=$(".msg_id",temp).text();
            
             $.ajax({
              
            url: '<?php echo base_url(); ?>welcome/read_message/',
            type:'POST',
            data:{'msg_id':msg_id},
            dataType: 'json',
            success: function(output_string){
               
               // $(temp).next('.click_here .unread_icon').hide(); 
             
               $(temp).next('.click_here').show();
                $('view',temp).html("Close");
                $('.unread_icon',temp).hide();
                } 
         ...
         else
         {
               ...
               $('view',temp).html("Click here to view message");
         }
    ...
    <div class="container">
        ...
        <section>
            ...
            <ul>
                ...
                <p> <a href="<?php echo base_url(); ?>welcome/index">Home</a> > Mails</p>
           ...
           <div class="profile_content">
               ...
               <div class="main_profile_content">
                   ...
                   <div id="profile_navigation">
                        ...
                        <ul>
                             <a href="">
                                 <li class="photo current" id="receive">
                                    Received messages
                                 </li>
                             </a>
                  ...
                  <div id="receiver_mail_body"> 
                   ...
                   <?php foreach($mail_info as $result) { ?>
                    ...
                    <div class="receive_mail">
                        ...
                        <p>From:<span><?php echo $result->sender_id; ?></span></p>
                        
                        <div class="options">
                               <div class="view_text">
                                   
                                   <span class="view">Click here to view message </span>
                              
                                <a href="<?php echo base_url(); ?>welcome/delete_mails/<?php echo $result->mail_id ;?>" onclick="return confirm('Are you sure want to delete?');"> Delete</a>
                                <span class="msg_id" style="visibility: hidden"><?php echo $result->mail_id; ?></span>
                               
                               <?php if($result->unread==0) { ?>
                               <img class="unread_icon" src="<?php echo base_url();?>images/mail.png" alt="not found" />
                                <?php } ?> 
                                </div>
