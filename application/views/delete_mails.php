...
<meta name="description" content="Dating Site,Message Functionality">
<meta charset="UTF-8" />
    ...
    <div class="container">
        ...
        <section>
            ...
            <div class="navigation">
                ...
                <p> <a href="<?php echo base_url(); ?>welcome/index">Home</a> > Delete Mails</p>
               ...
               <div class="main_profile_content">
                   ...
                   <div id="profile_navigation">
                        ...
                        <ul>
                             ...
                             <a href="">
                                 <li class="at_glance current" id="delete">
                                    Deleted messages
                                 </li>
                             </a>
                        ...
                        <p>From:<span><?php echo $result->sender_id; ?></span></p>
                         ...
                         <div class="options">
                               <div class="view_text">
                                ...
                                <a href="<?php echo base_url(); ?>welcome/back_to_receive/<?php echo $result->mail_id ;?>">Back to Receive</a>
