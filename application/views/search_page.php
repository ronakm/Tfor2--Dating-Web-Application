           ...
           <div class="profile_content">
               ...
               <div class="main_profile_content">
                   ...
                   <div id="search_form">
                       ...
                       <form method="post" action="<?php echo base_url();?>welcome/search_username">
                       ...
                       <ul>
                                <li>
                                    ...
                                    <span class="value search_input_field">
                                      <input type="text" name="username_search" id="search_username"> 
                                      
                                    
                                    </span>
                                    <div  id="username_error_msg">
                                ...
                                <li>
                                  ...
                                  <input type="submit" value="Search" class="button" onclick="return search_submit()" />
