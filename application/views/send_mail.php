...
<meta charset="UTF-8" />
<meta name="discription" content="Mail in Dating Site">
    ...
    <div class="container">
        ...
        <section>
            ...
            <div class="navigation">
                ...
                <p> <a href="<?php echo base_url(); ?>welcome/index">Home</a> > Send Mail</p>
           ...
           <div class="profile_content">
                   ...
                   <div class="option">
                       ...
                       <ul>
                           ...
                           <li>
                            ...
                            <li>
                               <a href="" class="email"><?php if($basic_info[0]->gender=="male") { ?>
                                   Email Him
                                <?php } else { ?>                                    
                                   Email Her
                                <?php } ?></a>
               ...
               <div class="main_profile_content">
                    ...
                    <div id="profile_navigation">
                        ...
                        <ul>
                             <a href="<?php echo base_url(); ?>welcome/others_upload_img/<?php echo $basic_info[0]->id; ?>">
                   ...
                   <div id="send_mail">
                       ...
                       <p class="heading"> Send <?php echo $basic_info[0]->username; ?> a message</p>
                       <form action="" method="post" id="send">
                           
                           <input type="text" placeholder="Subject" name="subject" id="subject"/> 
                           <div  id="subject_error_msg">
                           ...
                           <div  id="message_error_msg">
                             <div></div>
                                        
                           </div>
                           
                           <div class="mail_button">
                                <input type="submit" value="Send" onclick="var e = document.getElementById('send'); e.action='<?php echo base_url(); ?>welcome/send_mail/<?php  echo $basic_info[0]->id; ?>'; return send_check(); "/>
                                <input type="submit" value="Cancel" onclick=" var e = document.getElementById('send'); e.action='' "/>
