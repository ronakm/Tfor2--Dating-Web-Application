...
class Tank_auth
{
	 ...
	 * @return	bool
	 */
	function login($login, $password, $login_by_username, $login_by_email)
	{
	 ...
	 * @return	array
	 */
	function create_user($username, $email, $password, $email_activation,$postcode,$gender,$dob,$city,$age)
	{
		...
		if ((strlen($username) > 0) AND !$this->ci->users->is_username_available($username)) {
			...
			if($gender=="male")
			{
				$default_img="male.jpg";
			}
			else
			{
				$default_img="female.jpg";
			}			
